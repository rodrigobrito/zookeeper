namespace Org.Apache.Zookeeper.Proto
{
    ...
    public class SetMaxChildrenRequest : IRecord, IComparable
    {
        ...
        {
            SetMaxChildrenRequest request = (SetMaxChildrenRequest) obj;
            if (request == null)
            {
            ...
            if (num == 0)
            {
                num = (this.Max == request.Max) ? 0 : ((this.Max < request.Max) ? -1 : 1);
                if (num != 0)
                {
                    return num;
                }
        ...
        {
            SetMaxChildrenRequest objA = (SetMaxChildrenRequest) obj;
            if (objA == null)
            {
                return false;
            }
